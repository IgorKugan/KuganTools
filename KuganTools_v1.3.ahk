...
StopMoveDirectional() {
    ...
    sx := Round(gCenterX + dx * gStopDist)
    sy := Round(gCenterY + dy * gStopDist)
...
Ghost_GuiEnsure() {
    ...
    ; Melhor retículo (vermelho) com sombra preta
    ; Usa um símbolo mais "crosshair" e duas camadas pra dar contraste.
    Gui, Ghost:Font, s20 bold, Segoe UI Symbol
...
; -----------------------------------------------------------------------------
StopWalk_Init() {
    global gStopWalkKeys, gStopWalkPrev
    ...
    ; Top number row
    gStopWalkKeys.Push("1")
    gStopWalkKeys.Push("2")
    gStopWalkKeys.Push("3")
    gStopWalkKeys.Push("4")
    gStopWalkKeys.Push("5")
    gStopWalkKeys.Push("6")
    gStopWalkKeys.Push("7")
    gStopWalkKeys.Push("8")
    gStopWalkKeys.Push("9")
    gStopWalkKeys.Push("0")

    ; Numpad
    Loop, 10
        gStopWalkKeys.Push("Numpad" . (A_Index - 1))

    ; Arrow keys (useful when in WASD mode)
    gStopWalkKeys.Push("Up")
    gStopWalkKeys.Push("Left")
    gStopWalkKeys.Push("Down")
    gStopWalkKeys.Push("Right")
